...
func TestInitSwapWasmContract(t *testing.T) {
	...
	gasprice := uint64(2500)
	invokegaslimit := uint64(200000)
	contractAddr, err := common.AddressFromHexString("2193b435eb7153dfa844edb2867dd9a66058b0c4") //uniswapv2
	assert.Nil(t, err)
...
func TestPauseSwapWasmContract(t *testing.T) {
	...
	gasprice := uint64(2500)
	invokegaslimit := uint64(200000)
	contractAddr, err := common.AddressFromHexString("59dcfb1fb5bcc3679e6164f96724fc3baedd2db2") //wasmoep4 bridge
	assert.Nil(t, err)
	txHash, err := testOntSdk.WasmVM.InvokeWasmVMSmartContract(
...
func TestGetTxEvent(t *testing.T) {
	testOntSdk = NewOntologySdk()
	testOntSdk.NewRpcClient().SetAddress(testNetUrl)
	contractAddr, err := common.AddressFromHexString("824d3bbf8166fcededa271d1697ec3d67411d972") //wasm uniswap v2
	assert.Nil(t, err)
	user, err := common.AddressFromHexString("357be1f9e1c98b83f1ca1e363b79743019936d0f")
	assert.Nil(t, err)
...
func TestRegisterTokenPairSwapWasmContract(t *testing.T) {
	...
	gasprice := uint64(2500)
	invokegaslimit := uint64(200000)
	contractAddr, err := common.AddressFromHexString("59dcfb1fb5bcc3679e6164f96724fc3baedd2db2") //wasm uniswap v2
	assert.Nil(t, err)
...
func TestUnRegisterTokenPairSwapWasmContract(t *testing.T) {
	...
	gasprice := uint64(2500)
	invokegaslimit := uint64(200000)
	contractAddr, err := common.AddressFromHexString("59dcfb1fb5bcc3679e6164f96724fc3baedd2db2") //wasm uniswap
	assert.Nil(t, err)
	tokenPairName := "ONG_TO_WONT"
	txHash, err := testOntSdk.WasmVM.InvokeWasmVMSmartContract(
...
func TestGeTokenPairSwapWasmContract(t *testing.T) {
	testOntSdk = NewOntologySdk()
	testOntSdk.NewRpcClient().SetAddress(testNetUrl)
	contractAddr, err := common.AddressFromHexString("59dcfb1fb5bcc3679e6164f96724fc3baedd2db2") //wasm uniswapv2
	assert.Nil(t, err)
	tokenPairName := "ONG_TO_WONT"
