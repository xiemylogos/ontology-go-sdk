...
func TestDeploySwapGatewayWasmContract(t *testing.T) {
	...
	assert.Nil(t, err)
	wasmfile := "./uniswapv2gateway.wasm"
...
func TestInitSwapGatewayWasmContract(t *testing.T) {
	...
	gasprice := uint64(2500)
	invokegaslimit := uint64(200000)
	contractAddr, err := common.AddressFromHexString("0c0c44a3c15eaa8ac62d01547dcc775e69759166") //uniswapv2gatway
	assert.Nil(t, err)
...
func TestRegisterTokenPairSwapGatewayWasmContract(t *testing.T) {
	...
	gasprice := uint64(2500)
	invokegaslimit := uint64(200000)
	contractAddr, err := common.AddressFromHexString("0c0c44a3c15eaa8ac62d01547dcc775e69759166") //wasm uniswap v2gateway
	assert.Nil(t, err)
...
func TestSwapExactTokensForTokensSwapGatewayWasmContract(t *testing.T) {
	...
	gasprice := uint64(2500)
	invokegaslimit := uint64(200000)
	contractAddr, err := common.AddressFromHexString("0c0c44a3c15eaa8ac62d01547dcc775e69759166") //wasm uniswap v2
	assert.Nil(t, err)
	tokenPairName := "ONG_TO_WONT"
